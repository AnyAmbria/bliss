...
class CoreDataManager {
    ...
    func saveEmoji(data: Data) {
        ...
        let userEntity = NSEntityDescription.entity(forEntityName: "Emojis", in: managedContext) ?? NSEntityDescription()
    ...
    func saveAvatar(avatar: Avatars) {
        ...
        let avatarDB = Avatar(entity: userEntity ?? NSEntityDescription(), insertInto: managedContext)
        let url = URL(string: avatar.avatarURL ?? "") ?? URL(fileURLWithPath: "")
